...
This runs the app only on your computer, at `http://localhost:8502`.
...
The app opens automatically at `http://localhost:8502` in your browser.
...
Network URL: http://192.168.178.101:8502
```
...
```
Forwarding    https://abc123def456.ngrok.io -> http://localhost:8502
```
...
Something else is using port 8502. Streamlit will auto-switch to 8503, 8504, etc.
...
- Check that you have `scikit-learn` installed: `pip list | findstr scikit`
